...
# ╔═╡ 1a2aa480-c5fb-11ec-0c9d-3f26f688c3d0
begin
	using MLJ
	using CSV
	using DataFrames
...
# ╔═╡ e2fd2e63-afc8-4c30-93af-ef395c2d7c47
begin
...
# ╔═╡ bd6460d1-1450-49cc-8b1d-41f315f22325
XX, yy = @load_iris

# ╔═╡ de7c44ce-5373-45a1-b541-9444b8703dd2
yy

# ╔═╡ c4d5cee7-30cb-4ef1-b4df-aa92c96f0c8f
begin
	iris = CSV.read("./iris.data", DataFrame, header=false)
	rename!(iris, [:SepalLength, :SepalWidth, :PetalLength, :PetalWidth, :Species])
end

# ╔═╡ a148db08-4328-4c92-b832-84f28cca2c1e
y, X = unpack(iris, ==(:Species))

# ╔═╡ 9a9f82cb-cfe4-4944-9e14-180ef1a81ca7
y_r = categorical(y)

# ╔═╡ 674fa3c0-cc78-4231-bb9f-f93fe5802899
first(X, 3) |> pretty

# ╔═╡ 01fdc323-56f5-45e0-807a-f39a81a08eaf
begin
	rng = StableRNG(566)
	train, test = partition(eachindex(y), 0.7, shuffle=true, rng=rng)
end

# ╔═╡ 7d369fdd-6c68-4397-956b-bc5cd3e3c436
test[1:3]

# ╔═╡ 4e5049c1-9047-42da-ad3f-4c0043de058b
rfc = machine(rfc_model, X, y_r)

# ╔═╡ d41b445f-2522-4c8d-82a0-685ab05ab05f
fit!(rfc, rows=train)

# ╔═╡ 4c1c0c55-d58e-47df-9f6f-420e9662abef
fitted_params(rfc) |> pprint

# ╔═╡ 8cd1616a-207c-43c1-adce-d77f09cdfdd2
ŷ = predict(rfc, rows=test)

# ╔═╡ b352ed35-3a6a-4cc1-920d-88661d0b382a
@show ŷ[1]

# ╔═╡ 0d17c4df-3a10-4035-9bd6-fe962a5664c4
begin
	mce = cross_entropy(ŷ, y[test]) |> mean
	round(mce, digits=4)
end

# ╔═╡ 7ca55c47-c089-45e8-9905-7949f6a3cfaa


# ╔═╡ 27274424-3f35-4e1f-953e-31f092dcae98
...
git-tree-sha1 = "573740596f233ea98dfac50007c58d7dca87073a"
