...
# ╔═╡ 369a3f11-76b3-4565-af9a-c2634cf8c697
begin
	using LinearAlgebra
	using Statistics
	using PlutoUI
...
# ╔═╡ 20ab7394-99ca-4077-9128-3400778db636
begin
	D = [
		1 3
		3 6
...
# ╔═╡ 4b6a862c-6dff-11ec-1434-9f98a02f1d1e
md""" #### 1.9. 確認問題
##### (1) 単回帰の実装
　$D_s$ に対して単回帰を行うプログラムを実装し、回帰直線 $ŷ = ax + b$ の係数$a$ と$b$ の値を求めよ。
"""

# ╔═╡ 487a72c1-5cee-453e-b641-ade7f0559099
function set_plot()
	plot(size=(500,500), xlim=(0,10), ylim=(0,10), framestyle=:box, legend=:topleft)
	plot!(xlabel="x", ylabel="y", gridalpha=0.5)
end

# ╔═╡ 74d3a000-b7cf-42fe-9121-996d4ec0e697
# 元データのプロット
let
	set_plot()
	scatter!(X, Y; label="")
...
# ╔═╡ 033b97fe-46e5-4b10-864f-f89683b5e2c5
md"""
##### (2) 回帰直線の描画
　単回帰の実装で求めた回帰直線をデータ点と共にグラフに描け。
"""

# ╔═╡ 9e00d987-f185-49dc-a7e3-b105a0e91fed
...
# ╔═╡ 2b829c63-4d10-4608-afa3-9b8a05b1f19d
let
...
# ╔═╡ 6d4a6786-a21b-4b10-a9fc-e0534e332d19
md"""
##### (3) 残差の計算
　各事例 $(x_i, y_i)$ に対して残差 $ϵ̂_i$ を求めよ。
"""

# ╔═╡ a5968f7d-b795-47e7-930a-17d98df15c0c
D

# ╔═╡ ef6142f3-8588-4a70-ae90-04a77d505b16


# ╔═╡ b390d4ff-d1fd-4b80-bd4e-998d12593b12
